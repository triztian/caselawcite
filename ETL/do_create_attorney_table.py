...
command.add_argument('DataPath', 
    metavar='data_path.json',
    type=str,
...
command.add_argument(
    ...
    '--sqlite',
    type=str,
    help='Path to the SQLite3 DB to be used'
)
...
command.add_argument(
    ...
    '--print',
    type=int,
    help="Only print the names, don't store them"
)
...
command.add_argument(
    ...
    '--clean',
    type=int,
    help="Clean / overwrite the SQLite DB"
)
...
command.add_argument(
    ...
    '--log-level',
    type=str,
    help='The log level; default is warning'
)
    ...
    for case in cases:
        ...
        for attorney in attorneys:
            ...
            try:
                ...
                logging.info(str(e))
                cur.execute('SELECT id FROM attorneys WHERE names = ? LIMIT 1', 
                    (attorney, ))
                result = cur.fetchone()
                if result:
